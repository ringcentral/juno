...
* **AppBar:** remove min-width

### Features

* **AppBar:** remove min-width ([deac1a0](https://github.com/ringcentral/juno/commit/deac1a04addece06a446a10d145584c3b0838b0d))
* **TimePicker:** remove prop `times`, pelease migrate to `value` ([7359670](https://github.com/ringcentral/juno/commit/73596705e6aa73733db278d407ca04d60a315fa2))


### Bug Fixes

* **storybook:** fix story name ([843e73f](https://github.com/ringcentral/juno/commit/843e73f663ad356888cd9fdf6cc252d10d788066))
...
* **Card:** rename type name ([e2e83e3](https://github.com/ringcentral/juno/commit/e2e83e328e4a42a4a927c0d5b67d906e5e688a54))
* **Chid:** support `color` and `focused` prop ([02337ed](https://github.com/ringcentral/juno/commit/02337edc430cc017fe8625b84fa9145e6f9128fc))
* **Downshift:** provide autocomplete mode default filter and export inputChanged state for outside use ([36f50ac](https://github.com/ringcentral/juno/commit/36f50ac6a470c5f98e485a914aa117e0de867fbb))
* **PortalManager:** updateProps support function param ([605d84c](https://github.com/ringcentral/juno/commit/605d84cd24ee70902c60bc42feaf62db6a424cc3))
* **SubMenu:** added ability to set placement via props ([7a11624](https://github.com/ringcentral/juno/commit/7a11624e9a087cac8c216f7ecc15a315a415db98))
* **SuggestionList:** support useSuggestionList ([64a496d](https://github.com/ringcentral/juno/commit/64a496d724b908e87359aac94ed7e4df202f197d))
* **TextField, Select, Downshift:** support color prop ([f862473](https://github.com/ringcentral/juno/commit/f862473eddc1b31073483550fb56419174ed8afe))
* **TextField:** color follow color prop in normal status ([5a6f677](https://github.com/ringcentral/juno/commit/5a6f677e694be1177139b0a4239b177ca164ceaa))
* **useSuggestionList, useDownshift:** export id ([b3a47d6](https://github.com/ringcentral/juno/commit/b3a47d6e6038de0e91b8eed044af40812ae99ae3))
* **Webstorm:** add .idea ([35c527d](https://github.com/ringcentral/juno/commit/35c527d6dc974e5ec8ed2f295f8388547e083ff6))
* **withTooltip:** fix withTooltip type error ([f8b4f5c](https://github.com/ringcentral/juno/commit/f8b4f5cab5854f23035997f0ee8a122044146301))


### Bug Fixes

* **Button:** fix button color prop to RcPaletteProp ([f8a1152](https://github.com/ringcentral/juno/commit/f8a1152d8a13cf1a30ee13d101b3a3e376e2777e))
* **Downshift:** fix inputChanged type to optional ([1f6d6bc](https://github.com/ringcentral/juno/commit/1f6d6bcf11fe826c95e2e58e57dfcc029fd2a773))
* **Downshift:** fix padding issue with ([a3a6bc6](https://github.com/ringcentral/juno/commit/a3a6bc6a81300c20523faf7d56ce36d8f2abfa2a))
* **Downshift:** support groupDefaultExpanded and fill miss type ([8d191af](https://github.com/ringcentral/juno/commit/8d191afe0adbfc20283261cafaa53222c2be2476))
* **PlainSelect:** fix wrapper with width issue ([c23d936](https://github.com/ringcentral/juno/commit/c23d93660829881c76185ecde60bae164636352e))
* **TimePicker:** add Math.floor check for minute ([cb47c8e](https://github.com/ringcentral/juno/commit/cb47c8ec42248b4a8ca39da1195ebc025cdd1a59))
* **TimePicker:** remove time number disabled check, always be clickable ([8e41c51](https://github.com/ringcentral/juno/commit/8e41c513859aadc6a668e9d98cfa3dc3a6d512ba))
* **useKeyboardMoveFocus:** fix when focusedIndex is -1 and move to 0 not move issue ([958ca29](https://github.com/ringcentral/juno/commit/958ca29c437cae9505d7061f95f96a1116042df3))
