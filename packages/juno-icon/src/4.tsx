...
const Icon4 = memo(
  forwardRef((props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
    ...
    >
      <path
        fill="#000"
        d="M17.594 7v5.753H19v.641c0 .067-.021.124-.062.17s-.105.069-.191.069h-1.154v2.368h-1.018v-2.368h-4.116c-.086 0-.161-.024-.224-.072s-.103-.108-.12-.179l-.117-.572 4.518-5.809h1.076zm-.966 1.3-3.377 4.453h3.325V9.041c0-.109.003-.226.01-.352l.015-.192.027-.198z"
      />
      <path
        fill="#9e9e9e"
