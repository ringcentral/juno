  ...
  forwardRef(
    (
      ...
      <svg
        ...
        {...props}
      >
        <path fill="var(--color56, #f1511b)" d="M15.403 15.403H4V4h11.403z" />
        <path
          fill="var(--color57, #80cc28)"
          d="M27.997 15.403H16.592V4h11.403v11.403z"
        />
        <path fill="var(--color58, #00adef)" d="M15.403 28H4V16.597h11.403z" />
        <path
          fill="var(--color59, #fbbc09)"
