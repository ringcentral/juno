...
describe('getNumberPickerBoundary', () => {
  it.each`
    ...
    ${1}  | ${sameAMPeriod}    | ${1}     | ${true}            | ${{ hour: { min: 3, max: 11 }, minute: { min: 30, max: 55 } }}
    ${2}  | ${sameAMPeriod}    | ${3}     | ${true}            | ${{ hour: { min: 3, max: 11 }, minute: { min: 30, max: 55 } }}
    ...
    ${6}  | ${sameAMPeriod}    | ${1}     | ${false}           | ${{ hour: { min: 3, max: 11 }, minute: { min: 30, max: 55 } }}
    ${7}  | ${sameAMPeriod}    | ${3}     | ${false}           | ${{ hour: { min: 3, max: 11 }, minute: { min: 30, max: 55 } }}
    ...
    ${11} | ${samePMPeriod}    | ${1}     | ${true}            | ${{ hour: { min: 4, max: 11 }, minute: { min: 30, max: 55 } }}
    ${12} | ${samePMPeriod}    | ${16}    | ${true}            | ${{ hour: { min: 4, max: 7 }, minute: { min: 30, max: 55 } }}
    ...
    ${16} | ${samePMPeriod}    | ${1}     | ${false}           | ${{ hour: { min: 16, max: 19 }, minute: { min: 30, max: 55 } }}
    ${17} | ${samePMPeriod}    | ${16}    | ${false}           | ${{ hour: { min: 16, max: 19 }, minute: { min: 30, max: 55 } }}
    ...
    ${21} | ${differentPeriod} | ${1}     | ${true}            | ${{ hour: { min: 3, max: 11 }, minute: { min: 30, max: 55 } }}
    ${22} | ${differentPeriod} | ${3}     | ${true}            | ${{ hour: { min: 3, max: 11 }, minute: { min: 30, max: 55 } }}
    ...
    ${26} | ${differentPeriod} | ${1}     | ${false}           | ${{ hour: { min: 3, max: 19 }, minute: { min: 30, max: 55 } }}
    ${27} | ${differentPeriod} | ${3}     | ${false}           | ${{ hour: { min: 3, max: 19 }, minute: { min: 30, max: 55 } }}
