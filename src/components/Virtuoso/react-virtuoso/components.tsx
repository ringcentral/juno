...
type CompProps<T> = T extends React.ForwardRefExoticComponent<infer R>
  ? R
  : never;
type ListProps = CompProps<typeof List>;
type GridProps = CompProps<typeof Grid>;

export interface VirtuosoProps<D>
  extends Omit<ListProps, 'groupCounts' | 'groupContent' | 'itemsRendered'> {
  /**
  ...
  // TODO: wait complete understand that virtuoso component system, to remove all outside useRcPortalContext, and use pass window to implement that
  // TODO: then create a pr for original repo
  /**
...
export const Virtuoso = List as <D extends unknown = any>(
  props: VirtuosoProps<D> & { ref?: Ref<VirtuosoHandle> },
) => ReactElement;
