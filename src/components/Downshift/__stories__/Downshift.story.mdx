...
<Meta title="📖 Component Docs/Downshift" />
...
[Go to this canvas](?path=/story/🚀-cleanup-components-downshift--downshift)

<Canvas withSource="none">
  <Story id="🚀-cleanup-components-downshift--downshift" />
</Canvas>
...
<Canvas withSource="none">
  <Story id="🚀-cleanup-components-downshift--downshift-autocomplete" />
</Canvas>
...
<Canvas withSource="none">
  <Story id="🚀-cleanup-components-downshift--downshift-with-custom-input" />
</Canvas>
...
<Canvas withSource="none">
  <Story id="🚀-cleanup-components-downshift--downshift-disabled" />
</Canvas>
...
<Canvas withSource="none">
  <Story id="🚀-cleanup-components-downshift--downshift-with-avatar" />
</Canvas>
...
<Canvas withSource="none">
  <Story id="🚀-cleanup-components-downshift--downshift-fixed-item-height" />
</Canvas>
...
<Canvas withSource="none">
  <Story id="🚀-cleanup-components-downshift--downshift-group-by" />
</Canvas>
...
<Canvas withSource="none">
  <Story id="🚀-cleanup-components-downshift--downshift-debug" />
</Canvas>
...
<Canvas withSource="none">
  <Story id="🚀-cleanup-components-downshift--downshift-lazy-load-examples" />
</Canvas>
